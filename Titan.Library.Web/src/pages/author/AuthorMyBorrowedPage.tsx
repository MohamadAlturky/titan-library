...
type SortKey = keyof Pick<AuthorBorrowDto, 'id' | 'bookTitle' | 'customerName' | 'createdAt' | 'returnedAt' | 'isReturned'>;
...
export function AuthorMyBorrowedPage() {
  const [borrows, setBorrows] = useState<AuthorBorrowDto[]>([]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="My Books' Borrows" description="See who is borrowing your books" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-zinc-400">Total Borrows</p>
          </div>
        </div>
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="Book title or customer..."
                      ...
                      <div className="flex flex-col items-center gap-3 text-gray-400 dark:text-zinc-500">
                        ...
                        <p className="text-xs">
                          {hasActiveFilters
                            ...
                            : 'None of your books have been borrowed yet.'}
                        </p>
                        {hasActiveFilters && (
